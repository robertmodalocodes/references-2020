...
# dengan jarak setiap data yaitu 0.2 dalam rentang lambda 1 - 13
...
# nilai-nilai likelihood yaitu:
# naive likelihood dengan lambda 13
# n = 100, maximum likelihood = 7.515887, pada lambda 13, rata-rata = 3.622256
# n = 1000, maximum likelihood = 76.96942, pada lambda 12.8, rata-rata = 37.14666
# n = 2000, maximum likelihood = 156.9042, pada lambda 12.4, rata-rata = 77.55055

# dan log likelihood dengan lambda 13
# n = 100, max likelihood = 273.9877, pada lambda 13, rata-rata = -727.6815
# n = 1000, max likelihood = -2740.299, pada lambda 13, rata-rata = -7200.156
# n = 2000, max likelihood = -5414.138, pada lambda 13, rata-rata = -13969.11
# dari hasil yang didapatkan dapat dilihat bahwa 
# nilai native likelihood menunjukkan akurasi yang lebih baik
# dibanding nilai likelihood dengan menggunakan log-likelihood
# dapat dilihat bahwa pada native likelihood, semakin banyak jumlah data
# semakin tinggi nilai likelihoodnya
# sedangkan pada log-likelihood, semakin banyak jumlah data
# semakin kecil nilai maximum likelihoodnya
# dapat diambil kesimpulan bahwa model log-likelihood tidak cocok untuk

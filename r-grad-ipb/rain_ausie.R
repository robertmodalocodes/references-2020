# Tugas 2 Praktikum Topik Dalam Data Mining Terapan (KOM631)
# Nama  : Robert John Modalo
# NIM   : G651190331

# mengganti semua missing value dengan angka pada pada setiap atribut dalam dataset weatherAUS.CSV

airausie1 <- read.csv("../weatherAUS_exe.csv")
summary(airausie1)
...
write.table(airausie2, file="../rain_ausie2.csv", sep = ",", row.names = FALSE, na = " ")
